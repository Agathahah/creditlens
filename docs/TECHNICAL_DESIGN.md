...
Pilot lokal awal tanpa biaya cloud adalah usulan untuk tahap belajar, bukan batas akhir proyek. Staging merupakan lingkungan terpisah untuk latihan rilis dan rollback; Agatha sendiri menjalankan acceptance tests, tidak membutuhkan reviewer eksternal. Jika staging disetujui, pilih host dan batas akses setelah benchmark; credentials via environment/secret store, bindings internal, CORS terikat origin yang diperlukan. Tidak ada deploy yang diotorisasi dokumen ini.
